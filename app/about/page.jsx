...
export default async function Page() {
  ...
  return (
    <div className="grid items-center grid-cols-5 text-lg gap-x-24 gap-y-32">
          ...
          <p>
            {cabins.length > 0 ? (
              ...
              <span className="text-accent-400">
                We currently have no cabins available. Please check back later
                or explore other sections of our site for more information and
                updates.
              </span>
            )}
      ...
      {/* If the images is coming from the database */}
